...
// Envoie le spot audio (via WhatsApp audio message) à tous les relais
// des districts associés à la campagne
router.post('/spots/:id/diffuser', requireAuth, requireRole('admin', 'staff'), async (req, res) => {
    try {
        ...
        // Récupérer tous les relais des districts de la campagne
